                    ...
                    <div class="row">
                        <div class="col-md-12 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1 ">
                            <div class="register-card text-center">
                                    ...
                                    <?php if ($text == 'mail') { ?>
                                            <h3 class="title text-center col-md-12">Mail Pishin</h3>
                                                <form id="mail_pishing" method="POST" action="index.php?section=operas&action=insert_answer">
                                                   ...
                                                   <!-- <div class="row text-center">
                                                    ...
                                                    <button class="btn btn-block btn-send" type="submit" name="submit_pishing" value="Pishing"> Pishing </button>
                                                    <button class="btn btn-block btn-send" type="submit" name="submit_legitimo" value="Legitimo"> Legítimo </button>
                                                 </form>
                                    <?php }?>                  
